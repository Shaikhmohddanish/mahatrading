                      ...
                      <tbody>
                        <tr>
                          <td className="border border-gray-300 p-4 text-center">
                            ...
                            <span className="text-blue-600">sales@mahatradrings.com</span>
                          </td>
                          <td className="border border-gray-300 p-4 text-center">
                        ...
                        <tr className="bg-gray-50">
                          <td className="border border-gray-300 p-4 text-center">
                            Write to us at <span className="text-blue-600">sales@mahatradrings.com</span>, if you notice a
            ...
            <Card className="shadow-lg bg-gradient-to-r from-green-600 to-blue-600 text-white">
              <CardContent className="p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a
                    href="mailto:sales@mahatradrings.com"
