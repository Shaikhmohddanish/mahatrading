        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              ...
              provided by Maha Tradrings Trading Research.
            </p>
          </div>
            ...
            <Card className="mb-8 shadow-lg border-blue-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  alerts published by Maha Tradrings Trading Research on its website, mobile app, or other
                  platforms—whether in full or part—is strictly prohibited and will be considered a copyright
                  infringement. Maha Tradrings Trading Research (referred to as "Maha Tradrings Trading Research") is an
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-orange-200 bg-orange-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Please note, Maha Tradrings Trading Research is not an Investment Adviser. The information provided
                  should be used solely as a resource and at one's own risk. This content does not constitute an offer
                  to sell or a solicitation to buy any securities. Neither Maha Tradrings Trading Research nor its
            ...
            <Card className="mb-8 shadow-lg border-green-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  professional advice from a licensed Investment Adviser. Maha Tradrings Trading Research's reports and
                  ...
                  subject Maha Tradrings Trading Research to registration or licensing requirements in those countries.
                </p>
              </CardContent>
            </Card>
          </ScrollAnimation>
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-red-200 bg-red-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  All content and information provided by Maha Tradrings Trading Research are on an "As Is" basis.
                  Although we believe the information to be reliable, Maha Tradrings Trading Research does not guarantee
                  the completeness or accuracy of any content and expressly disclaims all warranties of any kind,
                  whether express or implied. Furthermore, Maha Tradrings Trading Research, its promoters, employees, and
                  affiliates may hold positions in the companies discussed in our research.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed mt-4">
                  By accessing the content of Maha Tradrings Trading Research, users agree to our Terms and Conditions of
                  Use. Past performance data presented does not guarantee future results. The user also agrees to
                  indemnify Maha Tradrings Trading Research, its promoters, employees, directors, and stakeholders from
            ...
            <Card className="mb-8 shadow-lg border-purple-200">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    Maha Tradrings Trading Research is not liable for any losses or gains resulting from investment
                  ...
                  <p>
                    Furthermore, Maha Tradrings Trading Research does not execute orders or provide brokerage services. If
                    anyone offers to execute trades on behalf of Maha Tradrings Trading Research, please deny such offers
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        informed insights, Maha Tradrings Trading Research does not guarantee returns or accuracy in
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-green-200 bg-green-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Maha Tradrings Trading Research has no litigation or legal disputes since its incorporation.
                </p>
              </CardContent>
            </Card>
          </ScrollAnimation>
            ...
            <Card className="mb-8 shadow-lg border-teal-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  ...
                  our representatives should not be considered official research services from Maha Tradrings Trading
                  Research.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="mb-8 shadow-lg bg-gradient-to-br from-blue-100 to-purple-100 border-2 border-blue-300">
              <CardContent className="p-8">
                ...
                <div className="bg-white p-6 rounded-lg border-l-4 border-blue-500">
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Maha Tradrings Trading Research, its promoters, employees, directors, or stakeholders may hold or have
          ...
          <ScrollAnimation direction="left">
            <Card className="mb-8 shadow-lg border-red-200">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Maha Tradrings Trading Research's reports and recommendations are intended for Indian residents only.
                  Any access or use of this content outside of India, especially in countries such as the USA, Canada,
                  or European Union, is prohibited, as it may subject Maha Tradrings Trading Research to registration or
