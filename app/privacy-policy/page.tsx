          ...
          <ScrollAnimation direction="right">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Maha Tradrings respects and values the Right to privacy of each and every individual. We are esteemed by
          ...
          <ScrollAnimation direction="right">
            <Card className="mb-8 shadow-lg border-green-200 bg-green-50">
              <CardContent className="p-8">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  This Privacy Policy of Maha Tradrings applies to the current clients as well as former clients. Below
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        By registering your mobile number on Maha Tradrings website – you agree to be contacted by our
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        ...
                        our services you agree that Maha Tradrings has the right to do so.
                      </p>
                    </div>
                  </div>
                </div>
