            ...
            <Card className="mb-8">
              <CardContent className="p-8 space-y-6">
                <p className="text-lg leading-relaxed">
                  By accessing or using the <span className="font-semibold text-green-600">Maha Tradings</span> website,
                  ...
                  Maha Tradings platform. Please note, we may update these terms from time to time, and your continued
                ...
                <p className="text-lg leading-relaxed">
                  The term <span className="font-semibold">Maha Tradings</span> refers to our website, mobile app, its
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    By subscribing to Maha Tradings's services, you confirm that the information provided during the
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    of partial or entire capital. You accept that Maha Tradings provides research and technical analysis
            ...
            <ScrollAnimation direction="right">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    You understand and agree that Maha Tradings and its team do not guarantee the accuracy or consistency
            ...
            <ScrollAnimation direction="left">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    You accept that Maha Tradings is not responsible for executing trades on your behalf. Any decisions
            ...
            <ScrollAnimation direction="right">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The research services provided by Maha Tradings are not to be mistaken for personalized investment
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    market, and you do not expect guaranteed or fixed returns from Maha Tradings's research alerts. You
            ...
            <ScrollAnimation direction="right">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The fees paid for Maha Tradings's research services are non-refundable under any circumstances. You
            ...
            <ScrollAnimation direction="left">
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    You agree that Maha Tradings and its owners, employees, or associates cannot be held responsible for
                    ...
                    alone are responsible for managing your account. You agree that Maha Tradings has not guaranteed or
              ...
              <Card className="bg-green-50 border-green-200">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    and conditions, disclaimers, disclosures, and policies mentioned on the Maha Tradings website and
                    mobile app. This consent will be recorded and considered final for all future services and
                    transactions with Maha Tradings.
                  </p>
                </CardContent>
              </Card>
            </ScrollAnimation>
